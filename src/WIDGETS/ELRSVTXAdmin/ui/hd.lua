...
WidgetUI.fonts = {
  sixth = { status = BOLD, cells = SMLSIZE, cellH = 22 },
  quarter = { status = BOLD, cells = SMLSIZE, cellH = 26 },
  third = { hero = MIDSIZE, cells = STDSIZE, cellH = 28 },
  half = { hero = MIDSIZE, cells = STDSIZE, cellH = 30 },
  full = { hero = DBLSIZE, cells = STDSIZE, cellH = 32 },
}

-- The corner radius on the preset cells, in this screen's pixels.
local CELL_ROUNDED = 6
